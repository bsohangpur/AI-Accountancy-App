...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.ExpenseInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).expense.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.ExpenseInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).expense.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.ExpenseInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).expense.findFirst(input as any))),

        findMany: procedure.input($Schema.ExpenseInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).expense.findMany(input as any))),
